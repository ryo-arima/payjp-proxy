...
func InitRouter(conf config.BaseConfig) *gin.Engine {
	...
	internalAPI.POST("/common", commonControllerForInternal.CreateCommon)
	internalAPI.PUT("/common", commonControllerForInternal.UpdateCommon)
	internalAPI.DELETE("/common", commonControllerForInternal.DeleteCommon)
	privateAPI.GET("/commons", commonControllerForPrivate.GetCommons)
	privateAPI.POST("/common", commonControllerForPrivate.CreateCommon)
	privateAPI.PUT("/common", commonControllerForPrivate.UpdateCommon)
	privateAPI.DELETE("/common", commonControllerForPrivate.DeleteCommon)
