...
type BalanceControllerForPrivate interface {
...
type balanceControllerForPrivate struct {
	BalanceRepository repository.BalanceRepository
}

func (balanceController balanceControllerForPrivate) GetBalances(c *gin.Context) {
